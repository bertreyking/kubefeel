...
func (s *Server) Run() error {
	...
	api.Use(s.authMiddleware())
	{
		...
		api.GET("/clusters/:id/workloads/:resourceType/:name/autoscaling", s.requirePermission(rbac.PermissionResourcesRead), s.getWorkloadAutoscaling)
		api.PUT("/clusters/:id/workloads/:resourceType/:name/autoscaling/hpa", s.requirePermission(rbac.PermissionResourcesWrite), s.upsertWorkloadHPA)
		api.DELETE("/clusters/:id/workloads/:resourceType/:name/autoscaling/hpa", s.requirePermission(rbac.PermissionResourcesWrite), s.deleteWorkloadHPA)
		api.PUT("/clusters/:id/workloads/:resourceType/:name/autoscaling/keda", s.requirePermission(rbac.PermissionResourcesWrite), s.upsertWorkloadScaledObject)
		api.DELETE("/clusters/:id/workloads/:resourceType/:name/autoscaling/keda", s.requirePermission(rbac.PermissionResourcesWrite), s.deleteWorkloadScaledObject)
		api.PUT("/clusters/:id/workloads/:resourceType/:name/autoscaling/knative", s.requirePermission(rbac.PermissionResourcesWrite), s.upsertWorkloadKnativeAutoscaling)
		api.DELETE("/clusters/:id/workloads/:resourceType/:name/autoscaling/knative", s.requirePermission(rbac.PermissionResourcesWrite), s.deleteWorkloadKnativeAutoscaling)
